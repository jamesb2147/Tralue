class BalancesController < ApplicationController
  ...
  private
    ...
    def balance_params
      params.require(:balance).permit(:user, :user_id, :mrbalance, :urbalance, :spgbalance, :tybalance, :aabalance, :babalance, :uabalance, :dlbalance, :asbalance, :nkbalance, :sqbalance, :labalance, :acbalance, :cxbalance, :brbalance, :eybalance, :afbalance, :gabalance, :mhbalance, :qfbalance, :qrbalance, :tgbalance, :vsbalance, :azbalance, :nhbalance, :ambalance, :lybalance, :habalance, :ibbalance, :vxbalance, :abbalance, :cabalance, :nzbalance, :ozbalance, :mubalance, :czbalance, :ekbalance, :g3balance, :hubalance, :jlbalance, :lhbalance, :svbalance, :vabalance)
    end
end
